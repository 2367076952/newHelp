...
//                    获取疑似出生天份
        ...
        int i1 = date.get(Calendar.YEAR) - year;
//                    获取了疑似年龄
        return Calendar.MONTH > month ? ++i1 : Calendar.MONTH == month ? Calendar.DATE >= day ? ++i1 : i1 : i1;
     ...
     * @return
     */
    public String getCensusRegisterIdCard(Integer v) {

        return getNameString(v);
    }
     ...
     * @return
     */
    public String getNameString(int code) {
        switch (code) {
            case 11:
                return "北京市";
            case 1101:
