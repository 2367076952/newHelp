...
import com.nayuniot.annotation.DataPermission;
                ...
                if (q != null) {
                    ...
                    switch (q.type()) {
                        ...
                        case IS_NULL:
                            ...
                            break;
                        case OR_LIKE:
                            LinkedHashSet likes = (LinkedHashSet) val;
                            Predicate likeTest = null;
                            for (Object like : likes) {
                                if (likeTest != null)
                                    likeTest = cb.or(likeTest, cb.like(getExpression(attributeName, join, root)
                                            .as(String.class), "%" + like.toString() + "%"));
                                else
                                    likeTest = cb.like(getExpression(attributeName, join, root)
                                            .as(String.class), "%" + like.toString() + "%");
                            }
                            list.add(likeTest);
                            break;
